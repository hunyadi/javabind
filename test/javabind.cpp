...
JAVA_EXTENSION_MODULE()
{
    ...
    static_class<StaticSample>()
        ...
        .function<StaticSample::pass_value<uint8_t>>("pass_unsigned_byte")
        .function<StaticSample::pass_value<uint16_t>>("pass_unsigned_short")
        .function<StaticSample::pass_value<uint32_t>>("pass_unsigned_int")
